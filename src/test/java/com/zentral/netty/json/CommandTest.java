...
public class CommandTest {
	...
	public void heartBeatDataBinding() throws JsonGenerationException, JsonMappingException, IOException
	{
		...
		hb.setName(CommandEnum.HEARTBEAT);
	...
	@Test
	public void heartBeatTreeParse() throws JsonParseException, IOException 
	{
		String json = "{\"name\":\""+ CommandEnum.HEARTBEAT +"\",\"headers\":{\"source\":\"source1\",\"destination\":\"destination1\"},\"body\":\"HALO\"}";
		ObjectMapper mapper = new ObjectMapper();
		JsonNode node = mapper.readTree(json);
		JsonNode name = node.get("name");
		Assert.assertEquals(CommandEnum.HEARTBEAT, CommandEnum.valueOf(name.asText()));
	}
